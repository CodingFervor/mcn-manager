...
// 平台系统管理
export const SystemAnnouncementAPI = { list: (p) => wrap(api.get('/system-announcements/', { params: p })), create: (d) => api.post('/system-announcements/', d), update: (id, d) => api.put(`/system-announcements/${id}/`, d), remove: (id) => api.delete(`/system-announcements/${id}/`), stats: () => api.get('/system-announcements/stats/') }
export const PermissionPolicyAPI = { list: (p) => wrap(api.get('/permission-policies/', { params: p })), create: (d) => api.post('/permission-policies/', d), update: (id, d) => api.put(`/permission-policies/${id}/`, d), remove: (id) => api.delete(`/permission-policies/${id}/`), stats: () => api.get('/permission-policies/stats/') }
export const AuditLogAPI = { list: (p) => wrap(api.get('/audit-logs/', { params: p })), stats: () => api.get('/audit-logs/stats/') }
export const DataBackupAPI = { list: (p) => wrap(api.get('/data-backups/', { params: p })), create: (d) => api.post('/data-backups/', d), update: (id, d) => api.put(`/data-backups/${id}/`, d), remove: (id) => api.delete(`/data-backups/${id}/`), stats: () => api.get('/data-backups/stats/'), run: (id) => api.post(`/data-backups/${id}/run/`) }
export const HealthMonitorAPI = { list: (p) => wrap(api.get('/health-monitors/', { params: p })), create: (d) => api.post('/health-monitors/', d), update: (id, d) => api.put(`/health-monitors/${id}/`, d), stats: () => api.get('/health-monitors/stats/'), check: (id) => api.post(`/health-monitors/${id}/check/`) }
export const IntegrationConfigAPI = { list: (p) => wrap(api.get('/integration-configs/', { params: p })), create: (d) => api.post('/integration-configs/', d), update: (id, d) => api.put(`/integration-configs/${id}/`, d), remove: (id) => api.delete(`/integration-configs/${id}/`), stats: () => api.get('/integration-configs/stats/') }
export const WorkflowTemplateAPI = { list: (p) => wrap(api.get('/workflow-templates/', { params: p })), create: (d) => api.post('/workflow-templates/', d), update: (id, d) => api.put(`/workflow-templates/${id}/`, d), remove: (id) => api.delete(`/workflow-templates/${id}/`), stats: () => api.get('/workflow-templates/stats/') }
export const NotificationTemplateAPI = { list: (p) => wrap(api.get('/notification-templates/', { params: p })), create: (d) => api.post('/notification-templates/', d), update: (id, d) => api.put(`/notification-templates/${id}/`, d), remove: (id) => api.delete(`/notification-templates/${id}/`), stats: () => api.get('/notification-templates/stats/') }
export const ReportSchedulerAPI = { list: (p) => wrap(api.get('/report-schedulers/', { params: p })), create: (d) => api.post('/report-schedulers/', d), update: (id, d) => api.put(`/report-schedulers/${id}/`, d), remove: (id) => api.delete(`/report-schedulers/${id}/`), stats: () => api.get('/report-schedulers/stats/') }
export const ExportCenterAPI = { list: (p) => wrap(api.get('/export-center/', { params: p })), create: (d) => api.post('/export-center/', d), stats: () => api.get('/export-center/stats/'), download: (id) => api.get(`/export-center/${id}/download/`) }
export const WhiteLabelConfigAPI = { list: (p) => wrap(api.get('/white-label-configs/', { params: p })), create: (d) => api.post('/white-label-configs/', d), update: (id, d) => api.put(`/white-label-configs/${id}/`, d), remove: (id) => api.delete(`/white-label-configs/${id}/`), stats: () => api.get('/white-label-configs/stats/') }
export const MultiTenantConfigAPI = { list: (p) => wrap(api.get('/multi-tenant-configs/', { params: p })), create: (d) => api.post('/multi-tenant-configs/', d), update: (id, d) => api.put(`/multi-tenant-configs/${id}/`, d), remove: (id) => api.delete(`/multi-tenant-configs/${id}/`), stats: () => api.get('/multi-tenant-configs/stats/') }
export const LicenseManagementAPI = { list: (p) => wrap(api.get('/license-management/', { params: p })), create: (d) => api.post('/license-management/', d), update: (id, d) => api.put(`/license-management/${id}/`, d), remove: (id) => api.delete(`/license-management/${id}/`), stats: () => api.get('/license-management/stats/') }
export const RiskAssessmentAPI = { list: (p) => wrap(api.get('/risk-assessments/', { params: p })), create: (d) => api.post('/risk-assessments/', d), update: (id, d) => api.put(`/risk-assessments/${id}/`, d), remove: (id) => api.delete(`/risk-assessments/${id}/`), stats: () => api.get('/risk-assessments/stats/') }
export const DisasterRecoveryAPI = { list: (p) => wrap(api.get('/disaster-recoveries/', { params: p })), create: (d) => api.post('/disaster-recoveries/', d), update: (id, d) => api.put(`/disaster-recoveries/${id}/`, d), remove: (id) => api.delete(`/disaster-recoveries/${id}/`), stats: () => api.get('/disaster-recoveries/stats/') }
export const ComplianceAuditAPI = { list: (p) => wrap(api.get('/compliance-audits/', { params: p })), create: (d) => api.post('/compliance-audits/', d), update: (id, d) => api.put(`/compliance-audits/${id}/`, d), remove: (id) => api.delete(`/compliance-audits/${id}/`), stats: () => api.get('/compliance-audits/stats/') }
export const SystemConfigAPI = { list: (p) => wrap(api.get('/system-configs/', { params: p })), create: (d) => api.post('/system-configs/', d), update: (id, d) => api.put(`/system-configs/${id}/`, d), remove: (id) => api.delete(`/system-configs/${id}/`), stats: () => api.get('/system-configs/stats/') }
export const FeatureFlagAPI = { list: (p) => wrap(api.get('/feature-flags/', { params: p })), create: (d) => api.post('/feature-flags/', d), update: (id, d) => api.put(`/feature-flags/${id}/`, d), remove: (id) => api.delete(`/feature-flags/${id}/`), stats: () => api.get('/feature-flags/stats/') }
export const ApiKeyManagementAPI = { list: (p) => wrap(api.get('/api-key-managements/', { params: p })), create: (d) => api.post('/api-key-managements/', d), update: (id, d) => api.put(`/api-key-managements/${id}/`, d), remove: (id) => api.delete(`/api-key-managements/${id}/`), stats: () => api.get('/api-key-managements/stats/') }
export const DeploymentRecordAPI = { list: (p) => wrap(api.get('/deployment-records/', { params: p })), create: (d) => api.post('/deployment-records/', d), update: (id, d) => api.put(`/deployment-records/${id}/`, d), remove: (id) => api.delete(`/deployment-records/${id}/`), stats: () => api.get('/deployment-records/stats/') }
